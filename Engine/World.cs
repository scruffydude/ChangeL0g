...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateItems()
        {
            ...
            _items.Add(new Weapon(ITEM_ID_SPIDER_KILLER, "Spider Slayer", "Spider Slayers", 10, 20, 20));
        }
        ...
        private static void PopulateMonsters()
        {
            ...
            snake.LootTable.Add(new LootItem(ItemByID(ITEM_ID_SNAKE_FANG), 100, false));
