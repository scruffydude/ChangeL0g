...
namespace ChangelogConsole
{
    class Program
    {
        ...
        private const string HELP_MENU = "Type 'Help' to see a list of available commands";

        private const string MOVE_UNAVALIABLE = "You see no way to travel farther ";
        ...
        private static void ParseInput(string input)
        {
            switch (input)
            {
                ...
                case "north":
                    ...
                    {
                        Console.WriteLine(MOVE_UNAVALIABLE + input);
                    }
                    else
                    {
                        _player.MoveNorth();
        ...
        private static void ViewTraderInventory()
        {
